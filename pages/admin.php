...
<div id="acpContainer">
    ...
    <div class="acpContnet">
        ...
        ?>
            <div class="acpContnet">
                <form action="" method="post">
                    <div><b>Jauna linka nosaukums: </b>
                        <font color="red">*</font>:<br />
                    </div>
                    <input type="text" name="name" value="" size="" /><br />
                    <div><b>Linka adrese: </b>
                        <font color="red">*</font>:<br />
                    </div>
                    <input type="text" name="link" value="" size="" /><br />
                    <div><b>Links Būs redzams ?</b>
                        <font color="red">*</font>:<br /><br>
                    </div>

                    <input type="radio" name="visible" <?php if (isset($visible) && $visible == "true") echo "checked"; ?> value="1"> Jā!
                    <input type="radio" name="visible" <?php if (isset($visible) && $visible == "false") echo "checked"; ?> value="0"> Nē!
                    ...
                    ?>
                                <div class="acpContnet">
                                    <form action="" method="post">
                                        ...
                                        <input type="radio" name="visible" <?php if (isset($visible) or $data['visible'] == "true") echo "checked"; ?> value="1"> Jā!
                                        <input type="radio" name="visible" <?php if (isset($visible) or $data['visible'] == "false") echo "checked"; ?> value="0"> Nē!
                                        <br><br>
                                        <div><b>Linka novietojums </b>
                                            <font color="red">*</font>:<br />
                                        </div>
                ...
                if (isset($_POST['delete_mainNav'])) {
                    ...
                    <div class="acpContnet">
                        ...
                        ?>
                            <div class="acpContnet">
                                <form action="" method="post">
                                    <div><b>Jauns To do lista nosaukums </b>
                                        <font color="red">*</font>:<br />
                                    </div>
                                    <input type="text" name="title" value="" size="" /><br />
                                    <div><b>To do lista bilde </b>
                                        <font color="red">*</font>:<br />
                                    </div>
                                    <input type="text" name="photo" value="" size="" /><br />
                                    <div><b>To do lista texts </b>
                                        <font color="red">*</font>:<br />
                                    </div>
                                    <textarea name="text"></textarea><br />
