...
<!DOCTYPE html>
  <html>
    ...
    <body id="page_off">
      ...
      <h2><a class="page_off" href="http://hosts/project/portal_v2/">We'll be back shortly.</a></h2>
    </body>
  </html>
<?php
...
?>
  ...
  <script type="text/javascript">
    window.location = "<?php echo $pageConfig['page_url'] ?>"
  </script>
